...
func execVCRCassetteUpdate(buildID, today string, rnr ExecRunner, ctlr *source.Controller, vt *Tester) error {
	...
	replayingResult, replayingErr := vt.Run(Replaying, provider.Beta, nil)
